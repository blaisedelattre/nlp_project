...
def parse_args():
    ...
    parser.add_argument('--model_form_gen', type=str, default='cnn', help="Form of model, i.e cnn, rnn, etc.")
    ...
    parser.add_argument('--gen_bidirectional',  action='store_true', default=False, help='lstm bidrectional')
    # data
    parser.add_argument('--dataset', default='news_group', help='choose which dataset to run on. [default: news_group]')
    parser.add_argument('--max_length', type=int, default=80, help='max length') #80 de base pour review news
